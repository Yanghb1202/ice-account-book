...
function getCalorieInfo(dishName) {
  ...
  const calorieDB = {
    ...
    '蓝莓': { cal: 57, tip: '富含花青素，抗氧化好选择' },
    '蛋糕': { cal: 450, tip: '糖分脂肪双高，偶尔食用' },
    '煎饼': { cal: 350, tip: '碳水充足，搭配水果更佳' },
    '松饼': { cal: 320, tip: '松软可口，注意糖浆热量' },
    '甜点': { cal: 400, tip: '糖分较高，适量享用' },
    '奶油蛋糕': { cal: 480, tip: '奶油热量高，少量即可' },
    '水果蛋糕': { cal: 380, tip: '搭配新鲜水果，相对健康' },
    '芝士蛋糕': { cal: 550, tip: '芝士热量高，注意控制' },
    '千层蛋糕': { cal: 420, tip: '层次丰富，适量食用' },
    '抹茶': { cal: 350, tip: '抹茶粉富含抗氧化物质' },
    '拿铁': { cal: 150, tip: '牛奶咖啡，注意奶精热量' },
    '咖啡': { cal: 5, tip: '纯黑咖啡热量极低' },
    '果汁': { cal: 120, tip: '糖分较高，建议直接吃水果' },
    '可乐': { cal: 140, tip: '高糖饮料，不建议常喝' },
    '雪碧': { cal: 130, tip: '含糖汽水，注意控制' },
    '薯条': { cal: 400, tip: '油炸食品，热量较高' },
    '薯片': { cal: 500, tip: '油炸零食，热量高' },
    '饼干': { cal: 450, tip: '烘焙零食，适量食用' },
    '糖果': { cal: 400, tip: '纯糖零食，热量高' },
    '坚果': { cal: 600, tip: '健康脂肪，适量食用' },
    '巧克力蛋糕': { cal: 520, tip: '巧克力热量高，偶尔享用' },
    '冰淇淋蛋糕': { cal: 450, tip: '冰凉美味，控制分量' },
    '三明治': { cal: 380, tip: '营养均衡，早餐好选择' },
    '热狗': { cal: 450, tip: '加工肉类，适量食用' },
    '蛋挞': { cal: 300, tip: '酥皮热量高，注意控制' },
    '甜甜圈': { cal: 380, tip: '油炸甜食，热量较高' },
    '华夫饼': { cal: 350, tip: '松软可口，搭配水果' },
    '手抓饼': { cal: 480, tip: '油分较高，适量食用' },
    '关东煮': { cal: 200, tip: '清淡健康，选择清汤' },
    '章鱼烧': { cal: 320, tip: '日式小吃，适量食用' },
    '寿司饭': { cal: 350, tip: '米饭为主，控制食量' },
    '刺身': { cal: 200, tip: '优质蛋白，低脂健康' },
    '咖喱饭': { cal: 550, tip: '香料丰富，搭配蔬菜' },
    '蛋包饭': { cal: 500, tip: '鸡蛋包裹米饭，营养均衡' },
    '意面': { cal: 500, tip: '碳水充足，搭配酱料' },
    '焗饭': { cal: 550, tip: '芝士焗烤，热量较高' },
    '炒饭': { cal: 500, tip: '油分较高，搭配青菜' },
    '卤肉饭': { cal: 600, tip: '卤肉油脂高，适量食用' },
    '拌饭': { cal: 550, tip: '米饭配菜，营养均衡' },
    '石锅拌饭': { cal: 520, tip: '韩式风味，注意辣酱' },
    '炸酱面': { cal: 550, tip: '酱料油脂高，适量食用' },
    '担担面': { cal: 500, tip: '麻辣风味，注意油量' },
    '热干面': { cal: 520, tip: '芝麻酱热量高，适量食用' },
    '过桥米线': { cal: 450, tip: '汤底丰富，注意油脂' },
    '桂林米粉': { cal: 420, tip: '酸辣可口，适量食用' },
    '老友粉': { cal: 450, tip: '酸笋风味，注意控制' },
    '螺蛳粉': { cal: 750, tip: '米粉+油脂热量偏高，少辣油' },
    '酸辣粉': { cal: 480, tip: '酸辣开胃，注意油脂' },
    '土豆粉': { cal: 400, tip: '淀粉为主，搭配蔬菜' },
    '刀削面': { cal: 500, tip: '手工面条，碳水充足' },
    '拉面': { cal: 550, tip: '汤底盐分高，少喝汤' },
    '乌冬面': { cal: 400, tip: '日式面条，口感Q弹' },
    '荞麦面': { cal: 350, tip: '粗粮面条，相对健康' },
    '凉面': { cal: 450, tip: '清爽可口，注意酱料' },
    '拌面': { cal: 500, tip: '酱料油脂高，适量食用' },
    '炒饭': { cal: 550, tip: '油分较高，搭配青菜均衡饮食' },
    '韭菜': { cal: 25, tip: '低热量蔬菜，富含膳食纤维' }
  };
...
const commonFoods = [
  { name: '蛋糕', cal: 450, tip: '糖分脂肪双高，偶尔食用', icon: '🍰' },
  { name: '奶茶', cal: 420, tip: '糖分超标，建议三分糖或无糖', icon: '🥤' },
  { name: '炸鸡', cal: 890, tip: '油炸热量极高，每周不超过1次', icon: '🍗' },
  { name: '汉堡', cal: 650, tip: '快餐热量高，搭配沙拉均衡', icon: '🍔' },
  { name: '披萨', cal: 680, tip: '芝士热量高，选择薄底更健康', icon: '🍕' },
  { name: '薯条', cal: 400, tip: '油炸食品，热量较高', icon: '🍟' },
  { name: '寿司', cal: 320, tip: '生鲜优质蛋白，控制酱油用量', icon: '🍣' },
  { name: '火锅', cal: 800, tip: '选择清汤锅底，控制蘸料', icon: '🍲' },
  { name: '烧烤', cal: 750, tip: '高温烤制产生有害物质，适量食用', icon: '🍢' },
  { name: '炒饭', cal: 550, tip: '油分较高，搭配青菜均衡饮食', icon: '🍳' },
  { name: '牛肉面', cal: 480, tip: '蛋白充足，少油汤底更健康', icon: '🍜' },
  { name: '饺子', cal: 600, tip: '主食肉类一体，控制食用数量', icon: '🥟' },
  { name: '沙拉', cal: 320, tip: '低脂高蛋白，减脂友好', icon: '🥗' },
  { name: '牛排', cal: 550, tip: '优质蛋白，选择瘦肉部位', icon: '🥩' },
  { name: '冰淇淋', cal: 380, tip: '夏季解暑，控制分量', icon: '🍦' },
  { name: '水果', cal: 120, tip: '维生素丰富，注意糖分', icon: '🍎' },
  { name: '面包', cal: 380, tip: '选择全麦面包，避免过多果酱', icon: '🍞' },
  { name: '三明治', cal: 380, tip: '营养均衡，早餐好选择', icon: '🥪' },
  { name: '蛋挞', cal: 300, tip: '酥皮热量高，注意控制', icon: '🥧' },
  { name: '松饼', cal: 320, tip: '松软可口，注意糖浆热量', icon: '🥞' }
];
...
function buildRecognitionResponse(baiduResult) {
  ...
  if (candidates.length === 0) {
    return {
      ...
      data: {
        name: '请手动填写',
        cal: 0,
        tip: '没有识别到明确菜品，请从下方快速选择',
        confidence: 0,
        source: 'empty',
        candidates: [],
        recommended: commonFoods
      }
    };
  }
  ...
  return {
    ...
    data: {
      ...
      cal: best.cal,
      tip: lowConfidence
        ? '识别置信度偏低，建议从下方快速选择或手动编辑'
        : best.tip,
      confidence: best.confidence,
      source: 'baidu',
      candidates,
      recommended: lowConfidence ? commonFoods : []
    }
  };
}
